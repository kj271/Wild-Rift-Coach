        ...
        {imageBase64&&(<>
          <div className="bg-card/40 border border-border/40 rounded-xl overflow-hidden">
            ...
            <div className="p-3 space-y-3">
              ...
              {/* Right panel: bench + pin-type column */}
              <div className="flex gap-1 shrink-0">
              {/* Bench zone */}
              <div ref={benchRef}
                className="relative w-14 rounded-lg border-2 border-dashed border-border/30 bg-black/20">
                  {benchPins.length===0&&(
              ...
              {/* Pin-type column — vertical, to the right of bench */}
                ...
                {(["me","ally","enemy","obj","ally_wave","enemy_wave"] as const).map(type=>{
                  ...
                  return(
                    <button key={type}
                      ...
                      className={cn("relative flex flex-col items-center justify-center gap-0.5 w-10 py-1.5 rounded-lg border text-[8px] font-bold transition-all active:scale-95 font-display",
                      ...
                      {type==="ally_wave"&&<span className="text-xs leading-none">~</span>}
                      {type==="enemy_wave"&&<span className="text-xs leading-none">~</span>}
                      <span>{label}</span>
